...
import IndexPageDigiLabs from './newWebsite/indexPage';
import DigiAbout from './newWebsite/DigiAbout';
import ContactDigi from './newWebsite/contactDigi';
import ServicesDigi from './newWebsite/ServicesDigi';
        ...
        return(
            <BrowserRouter basename={'/'}>
                <Switch>
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL}/`} component={IndexPageDigiLabs}/>
                    <Route exact path={`${process.env.PUBLIC_URL}/digiAbout`} component={DigiAbout}/>
                    <Route exact path={`${process.env.PUBLIC_URL}/digiContact`} component={ContactDigi}/>
                    <Route exact path={`${process.env.PUBLIC_URL}/digiService`} component={ServicesDigi}/>
